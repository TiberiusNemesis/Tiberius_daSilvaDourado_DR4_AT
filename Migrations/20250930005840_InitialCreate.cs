    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourPackageDestination", x => new { x.DestinationsId, x.TourPackagesId });
                    table.ForeignKey(
                        name: "FK_TourPackageDestination_Destinations_DestinationsId",
                        column: x => x.DestinationsId,
                        principalTable: "Destinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TourPackageDestination_TourPackages_TourPackagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourPackageDestination_TourPackagesId",
                table: "TourPackageDestination",
